...
public class Comment {
    ...
    public Comment(CommentEntry commentEntry) {
        this.postId = commentEntry.getPostId();
        this.createDate = LocalDate.parse(commentEntry.getCreateDate());
        this.commenterName = commentEntry.getCommenterName();
        this.comment = commentEntry.getComment();
    }

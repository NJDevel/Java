...
insert into users (username, password, enabled) values ('staffUser', '$2a$10$gecJu9i6hlyvCSZSWvk4EOqIz8xbzptC3v0F7cYtrOiHtJ6v0OqBq', true);
insert into users (username, password, enabled) values ('managerUser', '$2a$10$qyRBkq7NU6J7cVMvpYZeIOm6V2A8jgJh.Bqce4shWzvW6atztQg7i', true);
insert into users (username, password, enabled) values ('adminUser', '$2a$10$6W7lXOa0y6Iqh1iR0swj5eB2sJbZwMeuATCZ7dVFfQK69zIYxkPgq', true);

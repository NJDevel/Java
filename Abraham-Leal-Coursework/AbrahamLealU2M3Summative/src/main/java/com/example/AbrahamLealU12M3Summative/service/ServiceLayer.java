package com.example.AbrahamLealU12M3Summative.service;

import com.example.AbrahamLealU12M3Summative.customExceptions.ExcessiveSpendingError;
import com.example.AbrahamLealU12M3Summative.customExceptions.InsufficientInventoryException;
import com.example.AbrahamLealU12M3Summative.customExceptions.InvalidItemIdNumber;
import com.example.AbrahamLealU12M3Summative.customExceptions.InvalidUSStateError;
import com.example.AbrahamLealU12M3Summative.dao.*;
...
import com.example.AbrahamLealU12M3Summative.viewmodel.PurchaseViewModel;
...
public class ServiceLayer {
     ...
     * @return InvoiceViewModel returned when a valid purchase request has been sent to Game Rental Store API
     */
    @Transactional
